...
/*
 Generated class for the RecommendationAcer page.

 See http://ionicframework.com/docs/v2/components/#navigation for more info on
 Ionic pages and navigation.
 */
@Component({
  selector: 'page-recommendation-acer',
  templateUrl: 'recommendation-acer.html'
})
export class RecommendationAcerPage {
  items;
  count;
  //判断是否有数据
  status;
